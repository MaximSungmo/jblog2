...
public class BlogController {
	...
	public String blogMain(@PathVariable String id, @PathVariable Optional<Long> path1,
			@PathVariable Optional<Long> path2, Model model) {
	...
	public String adminWrite(@PathVariable("id") String id, @ModelAttribute("postvo") PostVo postvo, Model model) {
